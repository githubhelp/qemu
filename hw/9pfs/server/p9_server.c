/*
 * Server only code for 9p file system
 *   All functions that were virtio specific have been removed
 *       Their equivalent functions for xen are in xen-9p.c
 *
 * Copyright Linda R. Jacobson 2015
 * based largely on virtio-9p.c
